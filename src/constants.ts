...
export const OBS_INLINE_MATH_REGEXP: RegExp = /@#@#SWAPMEBB@#@/g;

// export const OBS_DISPLAY_MATH_REGEXP: RegExp = /\$\$([\s\S]*?)\$\$/g;
export const OBS_DISPLAY_MATH_REGEXP: RegExp = /@#@#SWAPMEBB@#@/g;

export const OBS_CODE_REGEXP: RegExp = /(?<!`)`(?=[^`])[\s\S]*?`/g;
// export const OBS_CODE_REGEXP: RegExp = /@#@#SWAPMEBB@#@/g;
